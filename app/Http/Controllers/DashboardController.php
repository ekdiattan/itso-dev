...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        return view('home.dashboard', ['title' => 'Dashboard', 'bookingWaiting' => $bookingWaiting, 'bookingBooked' => $bookingBooked, 'bookingReject' => $bookingReject, 'bookingDone' => $bookingDone]);
    }
}
